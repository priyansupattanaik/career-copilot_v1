...
from app.documents.service import DOCX_MIME, sha256_bytes
from app.core.errors import ApiError
from app.agents.llm import NvidiaClient
from app.db.repository import owned_row, write_activity
from app.resumes.evidence import ResumeBlock, build_blocks, evidence_bundle
from app.resumes.exports import render_docx
from app.resumes.improvement_repository import (
    completed_analysis,
    confirmed_jd,
    confirmed_version,
    create_run,
...
from app.resumes.validation import is_source_stale, validate_suggestion
